...
const input = `You are receiving a post object retrieved from the reddit API from the r/soccer subreddit. You need to analyze it and respond with a json object shaped like this: 
  ...
  mainSubject: string //  retrieve the main subject  (team, league, player, coach, president, supporters) of originalRedditTitle in few keywords, MAKE SURE THEY ARE FOOTBALL/SOCCER RELATED, they will be used to look for a relevant picture to post with the tweet
