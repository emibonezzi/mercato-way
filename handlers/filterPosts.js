...
const input = `You are receiving a post object retrieved from the reddit API from the r/soccer subreddit. You need to analyze it and respond with a json object shaped like this: 
  ...
  mainSubject: string //  Analyze the originalRedditTitle and URL to generate a concise query based on the main subject, focusing on the most relevant entity (e.g., team or player) and context (e.g., transfers, injuries). The generated query should reflect both the entity and the situation described in the title (e.g., "man city transfers" for a title about Manchester City transfers) 
